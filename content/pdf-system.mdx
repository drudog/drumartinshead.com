**Focus** — Systems Design · Document Automation · Brand Engineering
**Role** — Sole designer and engineer
**Timeline** — 2025
**Revenue impact** — Eliminated manual layout cost for a growing sales asset type
**Complexity** — Medium: Node.js, Puppeteer, CSS print layout, asset pipeline
...
Every study follows a fixed page structure: cover and practice intro → practice model → patient conversations → implementation → results → takeaways and QR code. Each page template is a reusable HTML/CSS layout that pulls from the content file — no copy-paste, no per-study adjustments.
...
<ImageGallery
  columns={2}
  items={[
    { src: "/images/work/pdf-system/kovel-cover.png", alt: "Elite Hearing of Colorado Springs — cover page", caption: "Cover — Elite Hearing of Colorado Springs" },
    { src: "/images/work/pdf-system/davis-cover.png", alt: "Davis Audiology — cover page", caption: "Cover — Davis Audiology (3-location practice, same system)" },
    { src: "/images/work/pdf-system/grote-cover.png", alt: "KC Hearing — cover page", caption: "Cover — KC Hearing" },
    { src: "/images/work/pdf-system/palmetto-cover.png", alt: "Palmetto Audiology — cover page", caption: "Cover — Palmetto Audiology" },
  ]}
/>

![Page 2 — practice model with sidebar pull quote and pricing callout](/images/work/pdf-system/kovel-practice-model.png)

![Page 3 — patient conversations with three-column cues section](/images/work/pdf-system/kovel-patient-conversations.png)

![Page 4 — implementation challenges with action checklist and pull quote](/images/work/pdf-system/kovel-implementation.png)

![Page 5 — two-panel results layout: practice impact and patient impact](/images/work/pdf-system/kovel-results.png)

<ImageGallery
  columns={2}
  items={[
    { src: "/images/work/pdf-system/kovel-takeaways.png", alt: "Key takeaways page with QR code", caption: "Page 6 — numbered summary rows, textured background, QR code" },
    { src: "/images/work/pdf-system/davis-takeaways.png", alt: "Davis Audiology takeaways page", caption: "Page 6 — Davis variant showing same layout, different content" },
  ]}
/>
