<MetaGrid>
  <MetaItem label="Focus" value="0→1 Product Leadership · DTC Therapeutic · Behavior-Change Design" />
  <MetaItem label="Role" value="Product Research, Lead Designer (End-to-End, Concept through Launch)" />
  <MetaItem label="Timeline" value="Under 4 months design" />
  <MetaItem label="Revenue Impact" value="New revenue channel opened" />
  <MetaItem label="Complexity" value="High: AI + Clinical + Legal + Emotional UX" />
</MetaGrid>
...
<div style={{position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden"}}>
  <iframe
    src="https://player.vimeo.com/video/1163653843?h=a29c803bca"
...
<div style={{position: "relative", paddingBottom: "56.25%", height: 0, overflow: "hidden"}}>
  <iframe
    src="https://embed.figma.com/design/kL6V19DhzIMhpJ6QBpUEOC/Portfolio-assets?node-id=319-18377&embed-host=share"
...
<ImageGallery
  columns={3}
  items={[
    { src: "/images/work/tinnitus-pro/key-screen-01.png", alt: "Sound Library", caption: "Sound Library: custom saved soundscapes alongside a curated default catalog, with a persistent mini player" },
    { src: "/images/work/tinnitus-pro/key-screen-02.png", alt: "Clinician message during session", caption: "Personalized clinician message: AI-delivered feedback reinforces the therapeutic rationale mid-session" },
    { src: "/images/work/tinnitus-pro/key-screen-03.png", alt: "Mode selection and active Habituation session", caption: "Mode selection and active session: four therapy modes with a live Habituation session showing timer and therapeutic volume control" },
    { src: "/images/work/tinnitus-pro/key-screen-04.png", alt: "Learn section", caption: "Learn: curated educational content with a next-up queue covering thought awareness, sound therapy, and behavior change" },
    { src: "/images/work/tinnitus-pro/key-screen-05.png", alt: "Meditate section", caption: "Meditate: recommended body scan with searchable topic categories including breath, stress relief, and growth" },
    { src: "/images/work/tinnitus-pro/key-screen-06.png", alt: "Targeting mode pre-session summary", caption: "Targeting mode: pre-session summary showing mode, sound selection, and daily goal before starting therapy" },
  ]}
/>
