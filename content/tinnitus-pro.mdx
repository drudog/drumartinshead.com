...
<ImageGallery
  columns={3}
  items={[
    { src: "/images/work/tinnitus-pro/key-screen-01.png", alt: "Onboarding symptom intake flow", caption: "Onboarding as symptom triage: structured intake seeds the initial therapy prescription" },
    { src: "/images/work/tinnitus-pro/key-screen-02.png", alt: "Sound therapy session control", caption: "Sound therapy control: minimal UI to reduce cognitive load during sessions" },
    { src: "/images/work/tinnitus-pro/key-screen-03.png", alt: "Daily session player", caption: "Daily session player: therapy framing throughout, never app or content language" },
    { src: "/images/work/tinnitus-pro/key-screen-04.png", alt: "Progress dashboard", caption: "Progress dashboard: consistency over quantity, habit loop made visible" },
    { src: "/images/work/tinnitus-pro/key-screen-05.png", alt: "Session completion state", caption: "Session completion: reinforces the therapeutic milestone, not just task completion" },
    { src: "/images/work/tinnitus-pro/key-screen-06.png", alt: "Targeting mode session setup", caption: "Targeting mode: pre-session summary with mode, sound, and daily goal before play" },
  ]}
/>
