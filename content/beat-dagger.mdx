**Focus** — Side Project · Browser Audio Engineering · 0→1
**Role** — Sole designer and engineer
**Timeline** — 2026
**Live** — [beat-dagger.vercel.app](https://beat-dagger.vercel.app) · [github.com/drudog/beat-dagger](https://github.com/drudog/beat-dagger)
**Stack** — React 18 · Vite · Web Audio API · WaveSurfer.js · IndexedDB
