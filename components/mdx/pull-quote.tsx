...
export function PullQuote({
  ...
  return (
    <blockquote className="relative my-12 pt-8 not-italic">
      <span className="pointer-events-none select-none absolute -top-4 left-0 font-display text-8xl leading-none text-[color:var(--color-accent)]">
        &ldquo;
      </span>
